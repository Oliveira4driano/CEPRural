...
import Modelo.UsuarioTabelaModelo;
...
public class UsuarioPesquisaTela extends JFrame{
    ...
    private List<Usuario> usuarios = new ArrayList<Usuario>(); //tabela 
    private Usuario usuarioSelecionado;
    
    public UsuarioPesquisaTela() {      
        usuario.setLogin("");
        initComponents();
        pesquisar();
    ...
    private void pesquisarBD(){
         ...
         usuarios= dao.pesquisar(usuario);
    }  
    ...
    public void abrirTelaConsulta(){
        new UsuarioConsultaTela(usuarioSelecionado).setVisible(true);
    }
