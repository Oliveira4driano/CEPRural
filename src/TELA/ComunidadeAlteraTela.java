 ...
 * @author Jonathan
 */
public class ComunidadeAlteraTela extends javax.swing.JFrame {
    ...
    public ComunidadeAlteraTela() {
      
    }   
    
    public ComunidadeAlteraTela(Comunidade comunidade) {
       initComponents();
     ...
     public void preencherEstado(){
        ...
        try {
           ...
           // for(Estado  e: estados){
            ...
            Logger.getLogger(ComunidadeAlteraTela.class.getName()).log(Level.SEVERE, null, ex);
        }
        
    }
    
    private void preencherDados(){
         campoNome.setText(comunidade.getNome());
         campoQtd.setText(Integer.toString(comunidade.getQtd())); 
         for (Estado estado : estados) {
             if(estado.getSigla().equals(comunidade.getEstado().getSigla())){
                 jComboBoxEstado.setSelectedItem(estado.getSigla());
             }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComunidadeAlteraTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ComunidadeAlteraTela tela = new ComunidadeAlteraTela();
